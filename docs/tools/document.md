...
⼀个需求规约是⼀个软件项 / 产品 / 系统所有需求陈述的正式⽂档，是⼀个软件产品∕系统的概念模型。IEEE标准830-1998给出格式  
...
基于SRS，还会产⽣以下两个⽂档：初始测试计划和⽤⼾系统操作描述。
...
⽀持过程是软件⽣存周期过程的另⼀部分，编写并更新开发⽂档以及api⽂档在软件项⽬中有重要作⽤。
...
产品⽂档⾯向客⼾，内容上应忽略技术性的内容。我们常在github上写的readme可以看作⼀种简化的产品⽂档。  

### 文档结构

⼀般来说，开发⽂档主要包括项⽬简介、代码样例、issue以及问题、作者/社区联系⽅式（如何得到 support）、贡献者名单、安装说明、license。
...
件或⾮⾃由软件（proprietary software）所使⽤；MIT条款可与其他授权条款并存；另外，MIT 条
