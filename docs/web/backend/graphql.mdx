...
![GraphQL、Hasura、Apollo、PostgreSQL的架构](../assets/gql.drawio.svg)
...
![create table](../assets/hasura_create_table.png)
...
![foreign key](../assets/hasura_foreign_key.png)

这里将`author`的值设为 uuid 类型，并与`user._id`严格一致。我们点开`article`的`Relationships`可以看到推荐的关系设置：

![relationships](../assets/hasura_relations.png)
...
![graphiql](../assets/hasura_graphiql.png)
...
![permission](../assets/hasura_permissions.png)
...
![Apollo types.ts](../assets/apollo_typests.png)
...
![mutation](../assets/apollo_mutation.png)
